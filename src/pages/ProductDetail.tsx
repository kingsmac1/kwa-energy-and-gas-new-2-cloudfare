          ...
          <div className="mt-10 grid gap-12 lg:grid-cols-2">
            ...
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <button onClick={() => document.getElementById("request-form")?.scrollIntoView({ behavior: "smooth" })} className="group inline-flex items-center gap-3 rounded-2xl bg-[var(--brand-dark)] px-6 py-4 text-sm font-semibold text-white transition hover:bg-[var(--brand-blue)]">
