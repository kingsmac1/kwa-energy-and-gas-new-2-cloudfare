...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About — Kwa Gas and Energy Company Limited" },
      { name: "description", content: "Indigenous Nigerian integrated energy infrastructure and industrial solutions company. CAC RC 7971986. Vision, mission, values, HSSE culture and local-content commitment." },
      { property: "og:title", content: "About Kwa Gas and Energy" },
      { property: "og:description", content: "Indigenous expertise. Global standards. Bridging traditional and clean energy across Africa." },
    ],
  }),
  component: AboutPage,
});
