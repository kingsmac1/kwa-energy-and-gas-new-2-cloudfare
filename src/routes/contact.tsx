...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — Kwa Gas and Energy" },
      { name: "description", content: "Speak to our technical team about your energy project. Phone +234 703 549 6294, email info@kwagasandenergy.com, or visit our office in Uyo, Akwa Ibom." },
      { property: "og:title", content: "Contact Kwa Gas and Energy" },
      { property: "og:description", content: "Procurement, calibration, gas infrastructure or maintenance — we support your operations across Africa." },
    ],
  }),
